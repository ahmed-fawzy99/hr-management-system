...
defineProps({
    quote: {
        type: String,
        default: 'We cannot solve problems with the kind of thinking we employed when we came up with them.',
    },
    author: {
        type: String,
...
<template>
    <blockquote v-if="style===1"
        ...
        <div class="flex items-center divide-x-2 divide-gray-300 dark:divide-gray-700">
            <cite class="pt-1 text-sm text-gray-500 dark:text-gray-400">- {{ author }}</cite>
        </div>
    </blockquote>

    <blockquote v-else-if="style===2" class="relative mt-4">
        <svg
